...
public final class ConversationReplyPromptTemplatesV5 {
    ...
    public static String finalCheck(ReplyMode mode, ReplyDepth depth) {
        ...
        return switch (mode) {
            case EXPLORE -> "把作者已经给出的事实视为封闭清单。输出只能复述清单项、连接清单项或标明清单缺口；"
                    + "不得给任何清单项新增性质、例子、人物行为、发生过程或额外后果。"
                    + "缺少依据的连接保持未知，不用‘可能’或‘可以’补齐。";
            case COMPARE -> "把作者已经给出的事实视为封闭清单。比较正文、说明和取舍只能复述清单项、"
                    + "对照清单项或标明清单缺口；不得给任何清单项新增性质、例子、人物行为、心理反应、"
                    + "能力表现、交易规则、恢复条件或额外后果。缺少依据的维度明确写待定，不用‘可能’补齐。";
            default -> "";
        };
    }
